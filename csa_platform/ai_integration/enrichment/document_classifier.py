...
class DocumentClassifier:
    ...
    def _rate_limit(self) -> None:
        ...
        .. note:: This method uses ``asyncio.sleep`` when called from an
           async context and ``time.sleep`` otherwise.  Since the classifier
           is currently used synchronously this is safe, but the async-aware
           path is here for future-proofing.
        """
        import asyncio
