...
echo "[deploy-secret-expiry] 1/4 Enabling ACR public access (temporary)..."
...
echo "[deploy-secret-expiry] Waiting 35s for ACR network rule propagation..."
sleep 35

# 2 — build + push (restore ACR access even on failure)
restore_acr() {
  echo "[deploy-secret-expiry] Restoring ACR public access=Disabled..."
