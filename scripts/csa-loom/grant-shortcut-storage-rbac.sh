...
echo
echo "Done. The Console UAMI can now resolve shortcuts to $ACCT (both ADLS Gen2"
echo "and blob-only accounts work — the .dfs endpoint serves both). Allow ~60s for"
echo "AAD propagation. Create the shortcut in the Lakehouse → Shortcuts tab with"
