...
// `file:///E:/...` (three slashes, forward slashes) while the template builds
// `file://E:\...`. The endsWith() fallback masked that, so the guard worked by
// accident rather than by being right. pathToFileURL is the repo's existing
// pattern -- see scripts/ci/check-bicep-sync.mjs -- and is correct on both.
