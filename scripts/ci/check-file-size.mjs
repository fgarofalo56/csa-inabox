...
const ALLOWLIST = {
  ...
  "apps/fiab-console/lib/azure/cosmos-client.ts": { max: 1600, reason: "exhaustive Cosmos container registry (one accessor + lazy-create per container); grows one entry per new registry — WS-10.1 added the `autopilot` container" },
