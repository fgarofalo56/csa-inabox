...
const ALLOWLIST = {
  ...
  "apps/fiab-console/lib/azure/cosmos-client.ts": { max: 1600, reason: "exhaustive single-source container catalog (~60 containers, one accessor each; WS-4.2 function-registry, WS-5.2 a2a-tasks, WS-10.5 parity-autopilot-runs); crossed 1500 — ratchet-frozen, decomposition tracked in decomposition-plan.md" },
