...
const ALLOWLIST = {
  ...
  "apps/fiab-console/lib/azure/cosmos-client.ts": { max: 1600, reason: "central Cosmos container registry (declaration + mk() + accessor per container) appended by many parallel feature branches; ratchet-frozen — decompose by domain later" },
