...
const ALLOWLIST = {
  ...
  "apps/fiab-console/lib/azure/cosmos-client.ts": { max: 1600, reason: "Cosmos container registry — grows ~3 lines per feature container by design (WS-10.3 time-branches)" },
