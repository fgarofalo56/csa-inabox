...
const ALLOWLIST = {
  ...
  "apps/fiab-console/lib/azure/cosmos-client.ts": { max: 1520, reason: "central Cosmos container registry — every accessor lives here by design (WS-4.2 added function-registry); splitting is a WS-11 refactor" },
