...
const ALLOWLIST = {
  ...
  "apps/fiab-console/lib/azure/cosmos-client.ts": { max: 1600, reason: "central Cosmos container registry — every feature appends one container decl + ensure() line + accessor (WS-4.2 added function-registry; WS-10.4 added the unified `marketplace` container); ratchet-frozen, decomposition tracked in decomposition-plan.md" },
