...
const ALLOWLIST = {
  ...
  "apps/fiab-console/lib/azure/cosmos-client.ts": { max: 1600, reason: "the single exhaustive Cosmos container registry — one container decl + ensure() + accessor per feature (WS-4.2 function-registry; WS-5.2 a2a-tasks; WS-10.3 time-branches; WS-10.4 marketplace; WS-10.5 parity-autopilot-runs); ratchet-frozen, decomposition tracked in decomposition-plan.md" },
