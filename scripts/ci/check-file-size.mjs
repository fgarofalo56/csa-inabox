...
const ALLOWLIST = {
  ...
  "apps/fiab-console/lib/azure/cosmos-client.ts": { max: 1600, reason: "exhaustive single-source container catalog (~60 containers, one accessor each); crossed 1500 with the WS-10.5 parity-autopilot-runs ledger" },
