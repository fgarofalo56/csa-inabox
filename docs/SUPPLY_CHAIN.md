...
| --------------------------------------- | --------------------------------------- | ----------------------------------- | ------------------------ |
| Pinned, hash-verified Python deps       | (local) `scripts/update-locks.sh`       | `requirements/locks/*/requirements.txt`               | Maintainers, CI, Docker  |
...
The lock files in `requirements/locks/*/requirements.txt` are the single source of truth for
