[Home](../../README.md) > [Docs](../index.md) > [Research](index.md) > **Platform Research Report**
...
- [🏗️ 1. Azure Cloud-Scale Analytics Architecture](#1-azure-cloud-scale-analytics-architecture)
...
- [☁️ 5. Required Azure Services for a Complete Platform](#5-required-azure-services-for-a-complete-platform)
...
_This report was compiled from Microsoft's official Cloud Adoption Framework documentation, GitHub reference templates, and Azure architecture guidance. The information is current as of April 2026._
