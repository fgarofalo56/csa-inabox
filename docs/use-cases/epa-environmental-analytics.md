...
| **AQS** (Air Quality System)        | [`aqs.epa.gov/aqsweb/documents/data_api.html`](https://aqs.epa.gov/aqsweb/documents/data_api.html)                            | Daily (quality-assured data lags 6–12 months) | Historical air quality monitoring data — sample-level, daily, and annual summaries. Email/key authentication. API base path: `/data/api`.                                                                                                    |
...
| **EJScreen** (archived)             | `https://web.archive.org/web/2024/https://www.epa.gov/ejscreen`                                                               | Annual                                        | Environmental justice screening data at Census tract level — demographic indicators, pollution burden indices. The live EPA EJScreen tool and its FTP mirror were retired in 2025; archived snapshots remain the most reliable public source. |
| **Superfund / CERCLIS**             | `https://www.epa.gov/enviro/sems-overview` (docs); `https://enviro.epa.gov/enviro/efservice/SEMS_PUBLIC/JSON` (typed example) | Quarterly                                     | 1,300+ National Priorities List sites with contaminant, remediation, and community health data.                                                                                                                                               |

!!! tip "API Key Registration"
AirNow API keys are free and issued at [docs.airnowapi.org](https://docs.airnowapi.org/). Rate limit is 500 requests/hour per key. AQS uses a separate email/key pair — see the [AQS API documentation](https://aqs.epa.gov/aqsweb/documents/data_api.html) for sign-up and usage. All other sources are unauthenticated.
...
| EJScreen Tool                           | [https://web.archive.org/web/2024/https://www.epa.gov/ejscreen](https://web.archive.org/web/2024/https://www.epa.gov/ejscreen) (archived; the live EPA EJScreen page was retired in 2025) |
