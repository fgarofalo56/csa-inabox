...
| **NASA POWER API** (Prediction of Worldwide Energy Resources)   | Solar radiation, temperature, precipitation, wind speed — modeled for any lat/lon at daily/monthly/climatology temporal resolution.                  | JSON, CSV, NetCDF     | Daily       | `https://power.larc.nasa.gov/api/temporal/daily/point` (docs: `https://power.larc.nasa.gov/docs/services/api/`) |
...
| ------------------- | -------------------------------------------- | --------------------- | ------------------------------------------------------------------------------------------------ |
| `ls_nasa_power`     | `https://power.larc.nasa.gov/docs/services/api/` | None (open)           | No API key required                                                                              |
...
| `ls_nasa_opendata`  | `https://data.nasa.gov/`                     | App token (optional)  | Socrata API                                                                                      |
