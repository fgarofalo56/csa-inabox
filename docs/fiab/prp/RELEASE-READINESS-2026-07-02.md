...
| B2 | Live estate identifiers + operator PII published on the public docs site (live sub GUID, UAMI principalId, workspace GUID, 82+ `azurefd.net` hostnames, `admin@contoso.gov` in nav) | docs-help | High (was Critical) |
