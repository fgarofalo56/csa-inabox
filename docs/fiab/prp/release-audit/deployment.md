...
- defaults `REGION: eastus2` and hard-codes the legacy sub `363ef5d1-0e77-4594-a530-f51af23dbf8c` as ADMIN_SUB/DLZ_SUB/SUB fallback (lines 44-50), a specific Databricks host `adb-7405613013893759.19.azuredatabricks.net` (line 60), and live eastus2 Console-UAMI GUIDs (lines 70-71).
