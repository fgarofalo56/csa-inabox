...
| audit-T84 Semantic-model-bound Fabric App builder | fabric-build-2026 | Fabric Build 2026 #28: "Fabric Apps for Semantic Models — full web apps backed by semantic models"; Rayfin covers general case only | done | Model-bound app builder extending Rayfin (Model binding tab + App builder runtime + page wizards), real AAS binding; see docs/fiab/parity/rayfin-app.md | 8 |
