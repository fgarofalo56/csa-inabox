...
`pnpm vitest run lib/azure/__tests__/synapse-permissions-client.test.ts` (7 green).
Live walk (LOOM_DEFAULT_FABRIC_WORKSPACE UNSET): open a lakehouse → Permissions →
...
rows; principals display as UPNs throughout.
