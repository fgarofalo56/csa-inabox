...
Per the MCP-as-update-channel pattern from [PRP-05](https://github.com/fgarofalo56/csa-inabox/blob/csa-loom-pillar/PRPs/completed/csa-loom-pillar/PRP-05-mcp-server.md):
