...
- **Live console:** `loom-console:v0.10` (single revision, 100% traffic, build-marker confirms live code; HTML served no-cache). Sub `e093f4fd-5047-4ee4-968d-a56942c665f3`, rg `rg-csa-loom-admin-centralus`, host `csa-loom.limitlessdata.ai`.
