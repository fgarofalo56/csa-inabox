...
Event handling and messaging best practices for Azure analytics platforms.

---

## In This Section

- **[Event Grid Patterns](event-grid-patterns.md)** - Event-driven architecture patterns
