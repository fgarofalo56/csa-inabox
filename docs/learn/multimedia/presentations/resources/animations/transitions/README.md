---
title: "Transitions Resources - CSA-in-a-Box"
tags:
  - multimedia
  - presentations
  - resources
  - animations
---
# 📚 Transitions Resources - CSA-in-a-Box
...
Slide transition resources and effects for Cloud Scale Analytics presentations.
...
```text
resources/animations/transitions/
...
[Contribute Resources](https://github.com/fgarofalo56/csa-inabox-docs/issues/new?title=[Resource]+Transitions)
...
[Provide Feedback](https://github.com/fgarofalo56/csa-inabox-docs/issues/new?title=[Feedback]+Transitions-Resources)
