...
description: "[🏠 Home](../index.md) > [📖 Reference](./README.md) > 📚 Glossary"
tags:
  - reference
---
...
[🏠 Home](../index.md) > [📖 Reference](./README.md) > 📚 Glossary
...
__Related:__ [Delta Lake Guide](../06-code-examples/delta-lake-guide.md)
...
__Related:__ [Azure Data Factory Integration](../06-code-examples/integration/azure-data-factory.md)
...
__Related:__ [Architecture Overview](../03-architecture-patterns/reference-architectures/README.md)

### Apache Spark

Open-source distributed computing system for big data processing. Synapse Spark pools run Apache Spark workloads.

__Related:__ [Spark Performance](../05-best-practices/service-specific/synapse/spark-performance.md)

### Auto Loader

Delta Lake feature for incrementally and efficiently processing new data files as they arrive in cloud storage.

__Related:__ [Auto Loader Tutorial](../06-code-examples/delta-lake/ingestion/auto-loader.md)

### Azure Active Directory (Azure AD)

Microsoft's cloud-based identity and access management service. Now known as Microsoft Entra ID.

__Related:__ [Security Best Practices](../best-practices-extra/security/README.md)
...
__Related:__ [Azure Purview Integration](../06-code-examples/integration/azure-purview.md)
...
__Related:__ [Serverless SQL Overview](../03-architecture-patterns/service-architectures/serverless-sql/README.md)
...
__Related:__ [CDC Tutorial](../06-code-examples/delta-lake/cdc/change-data-capture.md)
...
__Related:__ [Serverless SQL Best Practices](../best-practices-extra/serverless-sql-best-practices/README.md)

### Columnar Storage

Data storage format that stores data tables by column rather than by row. Examples: Parquet, ORC.

__Related:__ [Performance Optimization](../05-best-practices/cross-cutting-concerns/performance/performance-optimization.md)
...
__Related:__ [Integration Guide](../06-code-examples/integration-guide.md)

### Data Lake

Storage repository that holds vast amounts of raw data in its native format until needed.

__Related:__ [Delta Lakehouse Architecture](../03-architecture-patterns/service-architectures/delta-lakehouse/README.md)

### Data Lakehouse

Architecture that combines the best features of data lakes and data warehouses.

__Related:__ [Delta Lakehouse Overview](../03-architecture-patterns/service-architectures/delta-lakehouse/README.md)
...
__Related:__ [Table Optimization](../06-code-examples/delta-lake/optimization/table-optimization.md)
...
__Related:__ [Serverless SQL Guide](../06-code-examples/serverless-sql-guide.md)
...
__Related:__ [Best Practices](../05-best-practices/cross-cutting-concerns/cost-optimization/README.md)
...
__Related:__ [Shared Metadata](../03-architecture-patterns/service-architectures/shared-metadata/README.md)
...
__Related:__ [Pipeline Best Practices](../05-best-practices/cross-cutting-concerns/development/pipeline-optimization.md)
...
__Related:__ [Private Link Architecture](../03-architecture-patterns/service-architectures/private-link-architecture.md)
...
__Related:__ [Query Optimization](../06-code-examples/serverless-sql/query-optimization.md)
...
|----------|-------------|
| [Architecture Overview](../03-architecture-patterns/reference-architectures/README.md) | Architectural concepts and patterns |
| [Best Practices](../05-best-practices/cross-cutting-concerns/cost-optimization/README.md) | Implementation best practices |
| [Tutorials](../tutorials/README.md) | Hands-on learning materials |
| [Code Examples](../06-code-examples/README.md) | Practical code samples |
