...
**Important:** Azure Government's FedRAMP authorization is _High_ (which exceeds Moderate); deploying to Gov gives you broader inheritance. However, several services are not yet GA in Gov — see [Government Service Matrix](../GOV_SERVICE_MATRIX.md).
