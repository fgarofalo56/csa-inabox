[Home](../README.md) > [Docs](index.md) > **Disaster Recovery**
...
[`ROLLBACK.md`](ROLLBACK.md), which covers _bad deploys_; this document
covers _regional unavailability_ (Azure region outage, networking
...
- [⚠️ 6. Known Gaps and Roadmap](#6-known-gaps-and-roadmap)
