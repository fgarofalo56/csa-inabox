...
resource resLogAnalyticsWorkspace 'Microsoft.OperationalInsights/workspaces@2022-10-01' = {
  ...
  properties: {
    sku: {
      ...
      capacityReservationLevel: parLogAnalyticsWorkspaceSkuName == 'CapacityReservation'
...
resource resDataCollectionRuleVMInsightsLock 'Microsoft.Authorization/locks@2020-05-01' = if (parDataCollectionRuleVMInsightsLock.kind != 'None' || parGlobalResourceLock.kind != 'None') {
  ...
  properties: {
    level: (parGlobalResourceLock.kind != 'None')
      ? parGlobalResourceLock.kind
      : parDataCollectionRuleVMInsightsLock.kind
    notes: (parGlobalResourceLock.kind != 'None')
      ? parGlobalResourceLock.?notes
      : parDataCollectionRuleVMInsightsLock.?notes
  }
}
...
resource resDataCollectionRuleChangeTrackingLock 'Microsoft.Authorization/locks@2020-05-01' = if (parDataCollectionRuleChangeTrackingLock.kind != 'None' || parGlobalResourceLock.kind != 'None') {
  ...
  properties: {
    level: (parGlobalResourceLock.kind != 'None')
      ? parGlobalResourceLock.kind
      : parDataCollectionRuleChangeTrackingLock.kind
    notes: (parGlobalResourceLock.kind != 'None')
      ? parGlobalResourceLock.?notes
      : parDataCollectionRuleChangeTrackingLock.?notes
  }
}
...
resource resDataCollectionRuleMDFCSQLLock 'Microsoft.Authorization/locks@2020-05-01' = if (parDataCollectionRuleMDFCSQLLock.kind != 'None' || parGlobalResourceLock.kind != 'None') {
  ...
  properties: {
    ...
    notes: (parGlobalResourceLock.kind != 'None')
      ? parGlobalResourceLock.?notes
      : parDataCollectionRuleMDFCSQLLock.?notes
  }
}
...
resource resLogAnalyticsWorkspaceSolutionsLock 'Microsoft.Authorization/locks@2020-05-01' = [
  for (solution, index) in parLogAnalyticsWorkspaceSolutions: if (parLogAnalyticsWorkspaceSolutionsLock.kind != 'None' || parGlobalResourceLock.kind != 'None') {
    ...
    properties: {
      level: (parGlobalResourceLock.kind != 'None')
        ? parGlobalResourceLock.kind
        : parLogAnalyticsWorkspaceSolutionsLock.kind
      notes: (parGlobalResourceLock.kind != 'None')
        ? parGlobalResourceLock.?notes
        : parLogAnalyticsWorkspaceSolutionsLock.?notes
    }
  }
]
