...
module governanceResources 'modules/governance.bicep' = {
  ...
  params: {
    ...
    privateDnsZoneIdPurview: enableDnsAndFirewallDeployment
      ? globalDnsZones.outputs.privateDnsZoneIdPurview
      : privateDnsZoneIdPurview
    privateDnsZoneIdPurviewPortal: enableDnsAndFirewallDeployment
      ? globalDnsZones.outputs.privateDnsZoneIdPurviewPortal
      : privateDnsZoneIdPurviewPortal
    privateDnsZoneIdStorageBlob: enableDnsAndFirewallDeployment
      ? globalDnsZones.outputs.privateDnsZoneIdBlob
      : privateDnsZoneIdBlob
    privateDnsZoneIdStorageQueue: enableDnsAndFirewallDeployment
      ? globalDnsZones.outputs.privateDnsZoneIdQueue
      : privateDnsZoneIdQueue
    privateDnsZoneIdEventhubNamespace: enableDnsAndFirewallDeployment
      ? globalDnsZones.outputs.privateDnsZoneIdNamespace
      : privateDnsZoneIdNamespace
    privateDnsZoneIdKeyVault: enableDnsAndFirewallDeployment
      ? globalDnsZones.outputs.privateDnsZoneIdKeyVault
...
module containerResources 'modules/container.bicep' = {
  ...
  params: {
    ...
    tags: tagsJoined
    subnetId: networkServices.outputs.serviceSubnet
    privateDnsZoneIdContainerRegistry: enableDnsAndFirewallDeployment
      ? globalDnsZones.outputs.privateDnsZoneIdContainerRegistry
...
module consumptionResources 'modules/consumption.bicep' = {
  ...
  params: {
    ...
    tags: tagsJoined
    subnetId: networkServices.outputs.serviceSubnet
    privateDnsZoneIdSynapseprivatelinkhub: enableDnsAndFirewallDeployment
      ? globalDnsZones.outputs.privateDnsZoneIdSynapse
    ...
    privateDnsZoneIdPbiDedicated: enableDnsAndFirewallDeployment
      ? globalDnsZones.outputs.privateDnsZoneIdPbiDedicated
      : ''
...
output privateDnsZoneIdKeyVault string = enableDnsAndFirewallDeployment
  ? globalDnsZones.outputs.privateDnsZoneIdKeyVault
  : ''
output privateDnsZoneIdDataFactory string = enableDnsAndFirewallDeployment
  ? globalDnsZones.outputs.privateDnsZoneIdDataFactory
  : ''
output privateDnsZoneIdDataFactoryPortal string = enableDnsAndFirewallDeployment
  ? globalDnsZones.outputs.privateDnsZoneIdDataFactoryPortal
  : ''
...
output privateDnsZoneIdSqlServer string = enableDnsAndFirewallDeployment
  ? globalDnsZones.outputs.privateDnsZoneIdSqlServer
  : ''
output privateDnsZoneIdMySqlServer string = enableDnsAndFirewallDeployment
  ? globalDnsZones.outputs.privateDnsZoneIdMySqlServer
  : ''
output privateDnsZoneIdNamespace string = enableDnsAndFirewallDeployment
  ? globalDnsZones.outputs.privateDnsZoneIdNamespace
  : ''
output privateDnsZoneIdSynapseDev string = enableDnsAndFirewallDeployment
  ? globalDnsZones.outputs.privateDnsZoneIdSynapseDev
  : ''
output privateDnsZoneIdSynapseSql string = enableDnsAndFirewallDeployment
  ? globalDnsZones.outputs.privateDnsZoneIdSynapseSql
  : ''
