...
var varVpnGwConfig = ((hubNetwork.parVpnGatewayEnabled.value) && (!empty(hubNetwork.parVpnGatewayConfig.value)) ? hubNetwork.parVpnGatewayConfig.value : json('{"name": "noconfigVpn"}'))

// param parExpressRouteGatewayConfig object = json('${hubNetwork.parExpressRouteGatewayConfig.value}')
var varErGwConfig = ((hubNetwork.parExpressRouteGatewayEnabled.value) && !empty(hubNetwork.parExpressRouteGatewayConfig.value) ? hubNetwork.parExpressRouteGatewayConfig.value : json('{"name": "noconfigEr"}'))
...
resource resDdosProtectionPlan 'Microsoft.Network/ddosProtectionPlans@2023-02-01' = if (bool(hubNetwork.parDdosEnabled.value)) {
...
resource resDDoSProtectionPlanLock 'Microsoft.Authorization/locks@2020-05-01' = if (hubNetwork.parDdosEnabled.value && (hubNetwork.parDdosLock.value.kind != 'None' || hubNetwork.parGlobalResourceLock.value.kind != 'None')) {
  ...
  properties: {
    level: (hubNetwork.parGlobalResourceLock.value.kind != 'None') ? hubNetwork.parGlobalResourceLock.value.kind  : hubNetwork.parDdosLock.value.kind 
    notes: (hubNetwork.parGlobalResourceLock.value.kind  != 'None') ? hubNetwork.parGlobalResourceLock.value.?notes : hubNetwork.parDdosLock.value.?notes
  }
}
...
resource resVirtualNetworkLock 'Microsoft.Authorization/locks@2020-05-01' = if (hubNetwork.parVirtualNetworkLock.value.kind != 'None' || hubNetwork.parGlobalResourceLock.value.kind != 'None') {
  ...
  properties: {
    level: (hubNetwork.parGlobalResourceLock.value.kind != 'None') ? hubNetwork.parGlobalResourceLock.value.kind : hubNetwork.parVirtualNetworkLock.value.kind
    notes: (hubNetwork.parGlobalResourceLock.value.kind != 'None') ? hubNetwork.parGlobalResourceLock.value.?notes : hubNetwork.parVirtualNetworkLock.value.?notes
  }
}
...
resource resBastionSubnetRef 'Microsoft.Network/virtualNetworks/subnets@2023-02-01' existing = if (hubNetwork.parAzBastionEnabled.value) {
  parent: resHubVnet
  name: 'AzureBastionSubnet'
}

resource resBastionNsg 'Microsoft.Network/networkSecurityGroups@2023-02-01' = if (hubNetwork.parAzBastionEnabled.value) {
...
resource resBastionNsgLock 'Microsoft.Authorization/locks@2020-05-01' = if (hubNetwork.parAzBastionEnabled.value && (hubNetwork.parBastionLock.value.kind != 'None' || hubNetwork.parGlobalResourceLock.value.kind != 'None')) {
  ...
  properties: {
    level: (hubNetwork.parGlobalResourceLock.value.kind != 'None') ? hubNetwork.parGlobalResourceLock.value.kind : hubNetwork.parBastionLock.value.kind
    notes: (hubNetwork.parGlobalResourceLock.value.kind != 'None') ? hubNetwork.parGlobalResourceLock.value.?notes : hubNetwork.parBastionLock.value.?notes
  }
}
...
resource resBastion 'Microsoft.Network/bastionHosts@2023-02-01' = if (hubNetwork.parAzBastionEnabled.value) {
  location: hubNetwork.parLocation
  ...
  properties: {
    ...
    enableTunneling: (hubNetwork.parAzBastionSku.value == 'Standard' && hubNetwork.parAzBastionTunneling.value) ? hubNetwork.parAzBastionTunneling.value : false
    ipConfigurations: [
      {
        name: 'IpConf'
        properties: {
...
resource resGatewaySubnetRef 'Microsoft.Network/virtualNetworks/subnets@2023-02-01' existing = if (hubNetwork.parVpnGatewayEnabled.value || hubNetwork.parExpressRouteGatewayEnabled.value ) {
  parent: resHubVnet
  name: 'GatewaySubnet'
}
...
module modGatewayPublicIp '../publicIp/publicIp.bicep' = [for (gateway, i) in varGwConfig: if ((gateway.name != 'noconfigVpn') && (gateway.name != 'noconfigEr')) {
  ...
  params: {
    parLocation: hubNetwork.parLocation
    parAvailabilityZones: toLower(gateway.gatewayType) == 'expressroute' ? hubNetwork.parAzErGatewayAvailabilityZones.value : toLower(gateway.gatewayType) == 'vpn' ? hubNetwork.parAzVpnGatewayAvailabilityZones.value : []
...
resource resVirtualNetworkGatewayLock 'Microsoft.Authorization/locks@2020-05-01' = [for (gateway, i) in varGwConfig: if ((gateway.name != 'noconfigVpn') && (gateway.name != 'noconfigEr') && (hubNetwork.parVirtualNetworkGatewayLock.value.kind != 'None' || hubNetwork.parGlobalResourceLock.value.kind != 'None')) {
  scope: resGateway[i]
  name: hubNetwork.parVirtualNetworkGatewayLock.value.?name ?? '${resGateway[i].name}-lock'
  properties: {
    level: (hubNetwork.parGlobalResourceLock.value.kind != 'None') ? hubNetwork.parGlobalResourceLock.value.kind : hubNetwork.parVirtualNetworkGatewayLock.value.kind
    notes: (hubNetwork.parGlobalResourceLock.value.kind != 'None') ? hubNetwork.parGlobalResourceLock.value.?notes : hubNetwork.parVirtualNetworkGatewayLock.value.?notes
  }
}]

resource resAzureFirewallSubnetRef 'Microsoft.Network/virtualNetworks/subnets@2023-02-01' existing = if (hubNetwork.parAzFirewallEnabled.value) {
  parent: resHubVnet
  name: 'AzureFirewallSubnet'
}

resource resAzureFirewallMgmtSubnetRef 'Microsoft.Network/virtualNetworks/subnets@2023-02-01' existing = if (hubNetwork.parAzFirewallEnabled.value && (contains(map(parSubnets, subnets => subnets.name), 'AzureFirewallManagementSubnet'))) {
  parent: resHubVnet
...
module modAzureFirewallMgmtPublicIp '../publicIp/publicIp.bicep' = if (hubNetwork.parAzFirewallEnabled.value && (contains(map(parSubnets, subnets => subnets.name), 'AzureFirewallManagementSubnet'))) {
...
resource resFirewallPolicies 'Microsoft.Network/firewallPolicies@2023-02-01' = if (hubNetwork.parAzFirewallEnabled.value && hubNetwork.parAzFirewallPoliciesEnabled.value) {
...
resource resFirewallPoliciesLock 'Microsoft.Authorization/locks@2020-05-01' = if (hubNetwork.parAzFirewallEnabled.value && (hubNetwork.parAzureFirewallLock.value.kind != 'None' || hubNetwork.parGlobalResourceLock.value.kind != 'None')) {
  ...
  properties: {
    level: (hubNetwork.parGlobalResourceLock.value.kind != 'None') ? hubNetwork.parGlobalResourceLock.value.kind : hubNetwork.parAzureFirewallLock.value.kind
    notes: (hubNetwork.parGlobalResourceLock.value.kind != 'None') ? hubNetwork.parGlobalResourceLock.value.?notes : hubNetwork.parAzureFirewallLock.value.?notes
  }
}
...
resource resAzureFirewall 'Microsoft.Network/azureFirewalls@2023-02-01' = if (hubNetwork.parAzFirewallEnabled.value) {
  dependsOn: [
    resGateway
  ]
...
resource resHubRouteTable 'Microsoft.Network/routeTables@2023-02-01' = if (hubNetwork.parAzFirewallEnabled.value) {
    ...
    routes: [
      {
        ...
        properties: {
          ...
          nextHopIpAddress: hubNetwork.parAzFirewallEnabled.value ? resAzureFirewall.properties.ipConfigurations[0].properties.privateIPAddress : ''
        }
      }
    ]
...
resource resHubRouteTableLock 'Microsoft.Authorization/locks@2020-05-01' = if (hubNetwork.parAzFirewallEnabled.value && (hubNetwork.parHubRouteTableLock.value.kind != 'None' || hubNetwork.parGlobalResourceLock.value.kind != 'None')) {
  ...
  properties: {
    level: (hubNetwork.parGlobalResourceLock.value.kind != 'None') ? hubNetwork.parGlobalResourceLock.value.kind : hubNetwork.parHubRouteTableLock.value.kind
    notes: (hubNetwork.parGlobalResourceLock.value.kind != 'None') ? hubNetwork.parGlobalResourceLock.value.?notes : hubNetwork.parHubRouteTableLock.value.?notes
  }
}
...
//If Azure Firewall is enabled we will deploy a RouteTable to redirect Traffic to the Firewall.
output outAzFirewallPrivateIp string = hubNetwork.parAzFirewallEnabled.value ? resAzureFirewall.properties.ipConfigurations[0].properties.privateIPAddress : ''

//If Azure Firewall is enabled we will deploy a RouteTable to redirect Traffic to the Firewall.
output outAzFirewallName string = hubNetwork.parAzFirewallEnabled.value ? hubNetwork.parAzFirewallName.value : ''

output outPrivateDnsZones array = (hubNetwork.parPrivateDnsZonesEnabled.value ? modPrivateDnsZones.outputs.outPrivateDnsZones : [])
output outPrivateDnsZonesNames array = (hubNetwork.parPrivateDnsZonesEnabled.value ? modPrivateDnsZones.outputs.outPrivateDnsZonesNames : [])
