...
resource pricingTiers 'Microsoft.Security/pricings@2024-01-01' = [
  for (pricing, index) in pricings: if(pricing.name != 'VirtualMachines' && pricing.name != 'CloudPosture' && pricing.name != 'Api'){
    name: pricing.name
    properties: {
...
resource pricingTiersApiSubPlan 'Microsoft.Security/pricings@2024-01-01' = [
  for (pricing, index) in pricings: if(pricing.name == 'Api') {
    name: pricing.name
    properties: {
      pricingTier: pricing.pricingTier
      subPlan: 'P1'
...
resource pricingTiersCloudPosture 'Microsoft.Security/pricings@2024-01-01' = [
  for (pricing, index) in pricings: if(pricing.name == 'CloudPosture') {
    name: pricing.name
    properties: {
          extensions: [
      {
...
// resource secureScores 'Microsoft.Security/secureScores@2020-01-01' existing = {
//   name: 'SecureScores'
// }
