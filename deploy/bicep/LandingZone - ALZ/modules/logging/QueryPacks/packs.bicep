// Metadata
metadata name = 'ALZ Bicep - Query Packs'
metadata description = 'Module used to deploy Query Packs'
...
metadata referenceInformation = 'Ref link to Git Repo: https://github.com/microsoft/AzureMonitorCommunity'
/**************************************************************************************************************************************************************************
Topic, Solutions and Categories allowed values:

Topic = 'Allowed values are:
...
resource resQueryPack 'Microsoft.OperationalInsights/queryPacks@2019-09-01' = [
  for queryPackName in distinctQueryPacks: {
    name: queryPackName
    location: location
    tags: tags
    properties: {}
...
module queryPackQueries 'queries.bicep' = [
  for (queryPackName, i) in distinctQueryPacks: {
