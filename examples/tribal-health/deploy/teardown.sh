#!/usr/bin/env bash
# =============================================================================
# CSA-in-a-Box: Per-Example Teardown — tribal-health
#
# Destroys resources deployed by this vertical's deploy steps (see README).
# Default resource group: rg-tribal-health-analytics
#
# Usage:
...
VERTICAL="tribal-health"
DEFAULT_RG="rg-tribal-health-analytics"
