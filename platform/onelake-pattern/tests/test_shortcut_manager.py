...
# multi-synapse tests have already injected a MagicMock for "azure".
...
class TestParseAbfssPath:
    ...
    def test_valid_abfss_path(self, manager):
    ...
    def test_invalid_scheme_raises(self, manager):
...
class TestCreateShortcut:
    ...
    def test_create_without_validation(self, manager):
    ...
    def test_create_with_explicit_source_domain(self, manager):
        shortcut = manager.create_shortcut(
            name="test",
    ...
    def test_create_with_expiration(self, manager):
...
class TestValidateAccess:
    ...
    def test_validate_accessible_path(self, mock_blob_cls, manager):
    ...
    @patch("azure.storage.blob.BlobServiceClient")
    def test_validate_nonexistent_container(self, mock_blob_cls, manager):
        mock_container = MagicMock()
    ...
    def test_validate_invalid_path(self, manager):
...
class TestRemoveShortcut:
    ...
    def test_remove_marks_inactive(self, manager):
        shortcut = manager.create_shortcut(
            name="to-revoke",
            source_path="abfss://c@acct.dfs.core.windows.net/",
            target_domain="consumer",
...
class TestListShortcuts:
    ...
    def test_list_active_only_excludes_revoked(self, manager):
...
class TestBulkValidation:
    ...
    @patch("azure.storage.blob.BlobServiceClient")
    def test_validate_all_updates_shortcut_status(self, mock_blob_cls, manager):
        mock_container = MagicMock()
        mock_container.exists.return_value = True
        mock_container.list_blobs.return_value = []
