...
│                  │────▶│   Topics         │────▶│ (Azure Func)   │
│ • Seismic feeds  │     │                  │     │                │
│ • AQI monitors   │     │ Routes events to │     │ Evaluates:     │
│ • Park sensors   │     │ subscriptions    │     │ • Thresholds   │
│ • Pipeline runs  │     │ by event type    │     │ • Anomalies    │
│ • Slot machines  │     │                  │     │ • Windows      │
│ • Data freshness │     │                  │     │ • Z-scores     │
└──────────────────┘     └──────────────────┘     └───────┬────────┘
                                                          │
                                                          ▼
                                                 ┌────────────────┐
