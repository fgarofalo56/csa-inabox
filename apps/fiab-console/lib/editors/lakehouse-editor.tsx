...
export function LakehouseEditor({ item, id }: Props) {
  ...
  // File picker (multi-select) → flat upload into the current folder.
  ...
  const ribbon: RibbonTab[] = useMemo(() => [
    { id: 'home', label: 'Home', groups: [
      { label: 'Files', actions: [
        ...
        { label: 'Upload folder', onClick: canFileAction && !uploading ? onFolderUploadClick : undefined, disabled: !canFileAction || uploading },
  ...
  ], [canFileAction, uploading, onUploadClick, onFolderUploadClick, onNewFolder, refreshActive, hasFile, activePath, selectFile, openLabelDialog, activeContainer, openPerms, openSettings]);
            ...
            {tab === 'files' && (
              <>
                <div className={s.toolbar}>
                  ...
                  <input ref={fileInputRef} type="file" hidden multiple onChange={onUploadChange} />
