/**
 * CopilotStudioAgentEditor — Vitest contract test (auto-generated).
 *
 ...
 *
 * Per .claude/rules/no-vaporware.md grading rubric, this brings copilot-studio-agent
 * from B-grade (functional, untested) to A-grade (functional + Vitest).
 */
import { describe, it, expect, beforeEach, afterEach, vi } from 'vitest';
import { render, screen, waitFor } from '@testing-library/react';
import { CopilotStudioAgentEditor } from '../copilot-studio-editors';
import { makeItem, installFetchMock } from './test-helpers';

describe('CopilotStudioAgentEditor', () => {
  ...
  it('mounts and surfaces at least one ribbon button', async () => {
    ...
    try {
      render(<CopilotStudioAgentEditor item={makeItem('copilot-studio-agent', 'Copilot Studio agent')} id="new" />);
