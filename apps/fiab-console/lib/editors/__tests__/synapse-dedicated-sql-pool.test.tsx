/**
 * SynapseDedicatedSqlPoolEditor — Vitest contract test (auto-generated).
 *
 ...
 *
 * Per .claude/rules/no-vaporware.md grading rubric, this brings synapse-dedicated-sql-pool
 * from B-grade (functional, untested) to A-grade (functional + Vitest).
 */
import { describe, it, expect, beforeEach, afterEach, vi } from 'vitest';
import { render, screen, waitFor } from '@testing-library/react';
import { SynapseDedicatedSqlPoolEditor } from '../synapse-sql-editors';
import { makeItem, installFetchMock } from './test-helpers';

describe('SynapseDedicatedSqlPoolEditor', () => {
  ...
  it('mounts and surfaces at least one ribbon button', async () => {
    ...
    try {
      render(<SynapseDedicatedSqlPoolEditor item={makeItem('synapse-dedicated-sql-pool', 'Synapse dedicated SQL pool')} id="new" />);
