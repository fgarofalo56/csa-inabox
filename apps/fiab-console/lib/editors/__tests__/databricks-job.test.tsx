/**
 * DatabricksJobEditor — Vitest contract test (auto-generated).
 *
 ...
 *
 * Per .claude/rules/no-vaporware.md grading rubric, this brings databricks-job
 * from B-grade (functional, untested) to A-grade (functional + Vitest).
 */
import { describe, it, expect, beforeEach, afterEach, vi } from 'vitest';
import { render, screen, waitFor } from '@testing-library/react';
import { DatabricksJobEditor } from '../databricks-editors';
import { makeItem, installFetchMock } from './test-helpers';

describe('DatabricksJobEditor', () => {
  ...
  it('mounts and surfaces at least one ribbon button', async () => {
    ...
    try {
      render(<DatabricksJobEditor item={makeItem('databricks-job', 'Databricks job')} id="new" />);
