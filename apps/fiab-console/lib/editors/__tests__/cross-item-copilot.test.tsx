/**
 * CrossItemCopilotEditor — Vitest contract test (auto-generated).
 *
 ...
 *
 * Per .claude/rules/no-vaporware.md grading rubric, this brings cross-item-copilot
 * from B-grade (functional, untested) to A-grade (functional + Vitest).
 */
import { describe, it, expect, beforeEach, afterEach, vi } from 'vitest';
import { render, screen, waitFor } from '@testing-library/react';
import { CrossItemCopilotEditor } from '../cross-item-copilot-editor';
import { makeItem, installFetchMock } from './test-helpers';

describe('CrossItemCopilotEditor', () => {
  ...
  it('mounts and surfaces at least one ribbon button', async () => {
    ...
    try {
      render(<CrossItemCopilotEditor item={makeItem('cross-item-copilot', 'Cross-item Copilot')} id="new" />);
