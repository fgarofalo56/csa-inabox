/**
 * DataProductInstanceEditor — Vitest contract test (auto-generated).
 *
 ...
 *
 * Per .claude/rules/no-vaporware.md grading rubric, this brings data-product-instance
...
describe('DataProductInstanceEditor', () => {
  ...
  it('mounts and surfaces at least one ribbon button', async () => {
    ...
    try {
      render(<DataProductInstanceEditor item={makeItem('data-product-instance', 'Data product instance')} id="new" />);
