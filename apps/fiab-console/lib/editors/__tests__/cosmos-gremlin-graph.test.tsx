/**
 * CosmosGremlinGraphEditor — Vitest contract test (auto-generated).
 *
 ...
 *
 * Per .claude/rules/no-vaporware.md grading rubric, this brings cosmos-gremlin-graph
 * from B-grade (functional, untested) to A-grade (functional + Vitest).
 */
import { describe, it, expect, beforeEach, afterEach, vi } from 'vitest';
import { render, screen, waitFor } from '@testing-library/react';
import { CosmosGremlinGraphEditor } from '../graph-editors';
import { makeItem, installFetchMock } from './test-helpers';

describe('CosmosGremlinGraphEditor', () => {
  ...
  it('mounts and surfaces at least one ribbon button', async () => {
    ...
    try {
      render(<CosmosGremlinGraphEditor item={makeItem('cosmos-gremlin-graph', 'Cosmos Gremlin graph')} id="new" />);
