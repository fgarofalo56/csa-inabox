/**
 * ContentSafetyEditor — Vitest contract test (auto-generated).
 *
 ...
 *
 * Per .claude/rules/no-vaporware.md grading rubric, this brings content-safety
 * from B-grade (functional, untested) to A-grade (functional + Vitest).
 */
import { describe, it, expect, beforeEach, afterEach, vi } from 'vitest';
import { render, screen, waitFor } from '@testing-library/react';
import { ContentSafetyEditor } from '../foundry-sub-editors';
import { makeItem, installFetchMock } from './test-helpers';

describe('ContentSafetyEditor', () => {
  ...
  it('mounts and surfaces at least one ribbon button', async () => {
    ...
    try {
      render(<ContentSafetyEditor item={makeItem('content-safety', 'Content Safety')} id="new" />);
