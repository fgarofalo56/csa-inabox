/**
 * CopilotTemplateLibraryEditor — Vitest contract test (auto-generated).
 *
 ...
 *
 * Per .claude/rules/no-vaporware.md grading rubric, this brings copilot-template-library
 * from B-grade (functional, untested) to A-grade (functional + Vitest).
 */
import { describe, it, expect, beforeEach, afterEach, vi } from 'vitest';
import { render, screen, waitFor } from '@testing-library/react';
import { CopilotTemplateLibraryEditor } from '../copilot-studio-editors';
import { makeItem, installFetchMock } from './test-helpers';

describe('CopilotTemplateLibraryEditor', () => {
  ...
  it('mounts and surfaces at least one ribbon button', async () => {
    ...
    try {
      render(<CopilotTemplateLibraryEditor item={makeItem('copilot-template-library', 'Copilot template library')} id="new" />);
