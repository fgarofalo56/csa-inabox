/**
 * SqlManagedInstanceEditor — Vitest contract test (auto-generated).
 *
 ...
 *
 * Per .claude/rules/no-vaporware.md grading rubric, this brings azure-sql-managed-instance
 * from B-grade (functional, untested) to A-grade (functional + Vitest).
 */
import { describe, it, expect, beforeEach, afterEach, vi } from 'vitest';
import { render, screen, waitFor } from '@testing-library/react';
import { SqlManagedInstanceEditor } from '../azure-sql-editors';
import { makeItem, installFetchMock } from './test-helpers';

describe('SqlManagedInstanceEditor', () => {
  ...
  it('mounts and surfaces at least one ribbon button', async () => {
    ...
    try {
      render(<SqlManagedInstanceEditor item={makeItem('azure-sql-managed-instance', 'SQL Managed Instance')} id="new" />);
