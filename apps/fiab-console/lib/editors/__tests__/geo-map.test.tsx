/**
 * GeoMapEditor — Vitest contract test (auto-generated).
 *
 ...
 *
 * Per .claude/rules/no-vaporware.md grading rubric, this brings geo-map
...
describe('GeoMapEditor', () => {
  ...
  it('mounts and surfaces at least one ribbon button', async () => {
    ...
    try {
      render(<GeoMapEditor item={makeItem('geo-map', 'Geo map')} id="new" />);
