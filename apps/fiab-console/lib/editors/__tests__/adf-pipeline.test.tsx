/**
 * AdfPipelineEditor — Vitest contract test (auto-generated).
 *
 ...
 *
 * Per .claude/rules/no-vaporware.md grading rubric, this brings adf-pipeline
...
describe('AdfPipelineEditor', () => {
  ...
  it('mounts and surfaces at least one ribbon button', async () => {
    ...
    try {
      render(<AdfPipelineEditor item={makeItem('adf-pipeline', 'ADF pipeline')} id="new" />);
