/**
 * SynapseSparkPoolEditor — Vitest contract test (auto-generated).
 *
 ...
 *
 * Per .claude/rules/no-vaporware.md grading rubric, this brings synapse-spark-pool
 * from B-grade (functional, untested) to A-grade (functional + Vitest).
 */
import { describe, it, expect, beforeEach, afterEach, vi } from 'vitest';
import { render, screen, waitFor } from '@testing-library/react';
import { SynapseSparkPoolEditor } from '../azure-services-editors';
import { makeItem, installFetchMock } from './test-helpers';

describe('SynapseSparkPoolEditor', () => {
  ...
  it('mounts and surfaces at least one ribbon button', async () => {
    ...
    try {
      render(<SynapseSparkPoolEditor item={makeItem('synapse-spark-pool', 'Synapse Spark pool')} id="new" />);
