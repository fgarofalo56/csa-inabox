/**
 * SynapsePipelineEditor — Vitest contract test (auto-generated).
 *
 ...
 *
 * Per .claude/rules/no-vaporware.md grading rubric, this brings synapse-pipeline
 * from B-grade (functional, untested) to A-grade (functional + Vitest).
 */
import { describe, it, expect, beforeEach, afterEach, vi } from 'vitest';
import { render, screen, waitFor } from '@testing-library/react';
import { SynapsePipelineEditor } from '../azure-services-editors';
import { makeItem, installFetchMock } from './test-helpers';

describe('SynapsePipelineEditor', () => {
  ...
  it('mounts and surfaces at least one ribbon button', async () => {
    ...
    try {
      render(<SynapsePipelineEditor item={makeItem('synapse-pipeline', 'Synapse pipeline')} id="new" />);
