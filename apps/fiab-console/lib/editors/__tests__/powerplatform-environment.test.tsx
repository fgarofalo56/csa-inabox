/**
 * PowerPlatformEnvironmentEditor — Vitest contract test (auto-generated).
 *
 ...
 *
 * Per .claude/rules/no-vaporware.md grading rubric, this brings powerplatform-environment
 * from B-grade (functional, untested) to A-grade (functional + Vitest).
 */
import { describe, it, expect, beforeEach, afterEach, vi } from 'vitest';
import { render, screen, waitFor } from '@testing-library/react';
import { PowerPlatformEnvironmentEditor } from '../powerplatform-editors';
import { makeItem, installFetchMock } from './test-helpers';

describe('PowerPlatformEnvironmentEditor', () => {
  ...
  it('mounts and surfaces at least one ribbon button', async () => {
    ...
    try {
      render(<PowerPlatformEnvironmentEditor item={makeItem('powerplatform-environment', 'Power Platform environment')} id="new" />);
