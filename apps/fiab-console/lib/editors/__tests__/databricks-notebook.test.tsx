/**
 * DatabricksNotebookEditor — Vitest contract test (auto-generated).
 *
 ...
 *
 * Per .claude/rules/no-vaporware.md grading rubric, this brings databricks-notebook
...
describe('DatabricksNotebookEditor', () => {
  ...
  it('mounts and surfaces at least one ribbon button', async () => {
    ...
    try {
      render(<DatabricksNotebookEditor item={makeItem('databricks-notebook', 'Databricks notebook')} id="new" />);
