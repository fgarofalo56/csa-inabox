/**
 * CopilotAnalyticsEditor — Vitest contract test (auto-generated).
 *
 ...
 *
 * Per .claude/rules/no-vaporware.md grading rubric, this brings copilot-studio-analytics
 * from B-grade (functional, untested) to A-grade (functional + Vitest).
 */
import { describe, it, expect, beforeEach, afterEach, vi } from 'vitest';
import { render, screen, waitFor } from '@testing-library/react';
import { CopilotAnalyticsEditor } from '../copilot-studio-editors';
import { makeItem, installFetchMock } from './test-helpers';

describe('CopilotAnalyticsEditor', () => {
  ...
  it('mounts and surfaces at least one ribbon button', async () => {
    ...
    try {
      render(<CopilotAnalyticsEditor item={makeItem('copilot-studio-analytics', 'Copilot analytics')} id="new" />);
