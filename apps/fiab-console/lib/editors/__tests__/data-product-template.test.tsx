/**
 * DataProductTemplateEditor — Vitest contract test (auto-generated).
 *
 ...
 *
 * Per .claude/rules/no-vaporware.md grading rubric, this brings data-product-template
 * from B-grade (functional, untested) to A-grade (functional + Vitest).
 */
import { describe, it, expect, beforeEach, afterEach, vi } from 'vitest';
import { render, screen, waitFor } from '@testing-library/react';
import { DataProductTemplateEditor } from '../data-product-editors';
import { makeItem, installFetchMock } from './test-helpers';

describe('DataProductTemplateEditor', () => {
  ...
  it('mounts and surfaces at least one ribbon button', async () => {
    ...
    try {
      render(<DataProductTemplateEditor item={makeItem('data-product-template', 'Data product template')} id="new" />);
