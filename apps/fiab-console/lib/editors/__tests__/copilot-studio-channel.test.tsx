/**
 * CopilotChannelEditor — Vitest contract test (auto-generated).
 *
 ...
 *
 * Per .claude/rules/no-vaporware.md grading rubric, this brings copilot-studio-channel
 * from B-grade (functional, untested) to A-grade (functional + Vitest).
 */
import { describe, it, expect, beforeEach, afterEach, vi } from 'vitest';
import { render, screen, waitFor } from '@testing-library/react';
import { CopilotChannelEditor } from '../copilot-studio-editors';
import { makeItem, installFetchMock } from './test-helpers';

describe('CopilotChannelEditor', () => {
  ...
  it('mounts and surfaces at least one ribbon button', async () => {
    ...
    try {
      render(<CopilotChannelEditor item={makeItem('copilot-studio-channel', 'Copilot channel')} id="new" />);
