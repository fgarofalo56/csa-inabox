/**
 * DatabricksClusterEditor — Vitest contract test (auto-generated).
 *
 ...
 *
 * Per .claude/rules/no-vaporware.md grading rubric, this brings databricks-cluster
 * from B-grade (functional, untested) to A-grade (functional + Vitest).
 */
import { describe, it, expect, beforeEach, afterEach, vi } from 'vitest';
import { render, screen, waitFor } from '@testing-library/react';
import { DatabricksClusterEditor } from '../databricks-editors';
import { makeItem, installFetchMock } from './test-helpers';

describe('DatabricksClusterEditor', () => {
  ...
  it('mounts and surfaces at least one ribbon button', async () => {
    ...
    try {
      render(<DatabricksClusterEditor item={makeItem('databricks-cluster', 'Databricks cluster')} id="new" />);
