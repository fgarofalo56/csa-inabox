/**
 * AiBuilderModelEditor — Vitest contract test (auto-generated).
 *
 ...
 *
 * Per .claude/rules/no-vaporware.md grading rubric, this brings ai-builder-model
 * from B-grade (functional, untested) to A-grade (functional + Vitest).
 */
import { describe, it, expect, beforeEach, afterEach, vi } from 'vitest';
import { render, screen, waitFor } from '@testing-library/react';
import { AiBuilderModelEditor } from '../powerplatform-editors';
import { makeItem, installFetchMock } from './test-helpers';

describe('AiBuilderModelEditor', () => {
  ...
  it('mounts and surfaces at least one ribbon button', async () => {
    ...
    try {
      render(<AiBuilderModelEditor item={makeItem('ai-builder-model', 'AI Builder model')} id="new" />);
