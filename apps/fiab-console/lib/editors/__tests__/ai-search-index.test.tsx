/**
 * AiSearchIndexEditor — Vitest contract test (auto-generated).
 *
 ...
 *
 * Per .claude/rules/no-vaporware.md grading rubric, this brings ai-search-index
 * from B-grade (functional, untested) to A-grade (functional + Vitest).
 */
import { describe, it, expect, beforeEach, afterEach, vi } from 'vitest';
import { render, screen, waitFor } from '@testing-library/react';
import { AiSearchIndexEditor } from '../foundry-sub-editors';
import { makeItem, installFetchMock } from './test-helpers';

describe('AiSearchIndexEditor', () => {
  ...
  it('mounts and surfaces at least one ribbon button', async () => {
    ...
    try {
      render(<AiSearchIndexEditor item={makeItem('ai-search-index', 'AI Search index')} id="new" />);
