/**
 * DataverseTableEditor — Vitest contract test (auto-generated).
 *
 ...
 *
 * Per .claude/rules/no-vaporware.md grading rubric, this brings dataverse-table
 * from B-grade (functional, untested) to A-grade (functional + Vitest).
 */
import { describe, it, expect, beforeEach, afterEach, vi } from 'vitest';
import { render, screen, waitFor } from '@testing-library/react';
import { DataverseTableEditor } from '../powerplatform-editors';
import { makeItem, installFetchMock } from './test-helpers';

describe('DataverseTableEditor', () => {
  ...
  it('mounts and surfaces at least one ribbon button', async () => {
    ...
    try {
      render(<DataverseTableEditor item={makeItem('dataverse-table', 'Dataverse table')} id="new" />);
