/**
 * DatabricksSqlWarehouseEditor — Vitest contract test (auto-generated).
 *
 ...
 *
 * Per .claude/rules/no-vaporware.md grading rubric, this brings databricks-sql-warehouse
 * from B-grade (functional, untested) to A-grade (functional + Vitest).
 */
import { describe, it, expect, beforeEach, afterEach, vi } from 'vitest';
import { render, screen, waitFor } from '@testing-library/react';
import { DatabricksSqlWarehouseEditor } from '../databricks-editors';
import { makeItem, installFetchMock } from './test-helpers';

describe('DatabricksSqlWarehouseEditor', () => {
  ...
  it('mounts and surfaces at least one ribbon button', async () => {
    ...
    try {
      render(<DatabricksSqlWarehouseEditor item={makeItem('databricks-sql-warehouse', 'Databricks SQL warehouse')} id="new" />);
