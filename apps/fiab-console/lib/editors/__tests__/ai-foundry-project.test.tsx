/**
 * ProjectEditor — Vitest contract test (auto-generated).
 *
 ...
 *
 * Per .claude/rules/no-vaporware.md grading rubric, this brings ai-foundry-project
 * from B-grade (functional, untested) to A-grade (functional + Vitest).
 */
import { describe, it, expect, beforeEach, afterEach, vi } from 'vitest';
import { render, screen, waitFor } from '@testing-library/react';
import { ProjectEditor } from '../foundry-sub-editors';
...
describe('ProjectEditor', () => {
  ...
  it('mounts and surfaces at least one ribbon button', async () => {
    ...
    try {
      render(<ProjectEditor item={makeItem('ai-foundry-project', 'AI Foundry project')} id="new" />);
