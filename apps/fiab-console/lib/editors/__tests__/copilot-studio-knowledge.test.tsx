/**
 * CopilotKnowledgeEditor — Vitest contract test (auto-generated).
 *
 ...
 *
 * Per .claude/rules/no-vaporware.md grading rubric, this brings copilot-studio-knowledge
 * from B-grade (functional, untested) to A-grade (functional + Vitest).
 */
import { describe, it, expect, beforeEach, afterEach, vi } from 'vitest';
import { render, screen, waitFor } from '@testing-library/react';
import { CopilotKnowledgeEditor } from '../copilot-studio-editors';
import { makeItem, installFetchMock } from './test-helpers';

describe('CopilotKnowledgeEditor', () => {
  ...
  it('mounts and surfaces at least one ribbon button', async () => {
    ...
    try {
      render(<CopilotKnowledgeEditor item={makeItem('copilot-studio-knowledge', 'Copilot knowledge source')} id="new" />);
