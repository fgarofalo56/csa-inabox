/**
 * SqlServer2025VectorIndexEditor — Vitest contract test (auto-generated).
 *
 ...
 *
 * Per .claude/rules/no-vaporware.md grading rubric, this brings sql-server-2025-vector-index
 * from B-grade (functional, untested) to A-grade (functional + Vitest).
 */
import { describe, it, expect, beforeEach, afterEach, vi } from 'vitest';
import { render, screen, waitFor } from '@testing-library/react';
import { SqlServer2025VectorIndexEditor } from '../azure-sql-editors';
import { makeItem, installFetchMock } from './test-helpers';

describe('SqlServer2025VectorIndexEditor', () => {
  ...
  it('mounts and surfaces at least one ribbon button', async () => {
    ...
    try {
      render(<SqlServer2025VectorIndexEditor item={makeItem('sql-server-2025-vector-index', 'SQL Server 2025 vector index')} id="new" />);
