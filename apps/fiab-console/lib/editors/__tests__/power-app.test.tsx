/**
 * PowerAppEditor — Vitest contract test (auto-generated).
 *
 ...
 *
 * Per .claude/rules/no-vaporware.md grading rubric, this brings power-app
...
describe('PowerAppEditor', () => {
  ...
  it('mounts and surfaces at least one ribbon button', async () => {
    ...
    try {
      render(<PowerAppEditor item={makeItem('power-app', 'Power App')} id="new" />);
