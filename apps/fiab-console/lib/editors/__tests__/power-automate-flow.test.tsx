/**
 * PowerAutomateFlowEditor — Vitest contract test (auto-generated).
 *
 ...
 *
 * Per .claude/rules/no-vaporware.md grading rubric, this brings power-automate-flow
 * from B-grade (functional, untested) to A-grade (functional + Vitest).
 */
import { describe, it, expect, beforeEach, afterEach, vi } from 'vitest';
import { render, screen, waitFor } from '@testing-library/react';
import { PowerAutomateFlowEditor } from '../powerplatform-editors';
import { makeItem, installFetchMock } from './test-helpers';

describe('PowerAutomateFlowEditor', () => {
  ...
  it('mounts and surfaces at least one ribbon button', async () => {
    ...
    try {
      render(<PowerAutomateFlowEditor item={makeItem('power-automate-flow', 'Power Automate flow')} id="new" />);
