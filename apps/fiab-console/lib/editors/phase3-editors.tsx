...
export function SemanticModelEditor({ item, id }: { item: FabricItemType; id: string }) {
  ...
  ], [refreshing, canRefresh, refreshNow, datasetId, detail?.dataset?.isRefreshable, focusNewMeasure, openInPbi, workspaceId, focusBuild, modelTables, selectedTableName]);
