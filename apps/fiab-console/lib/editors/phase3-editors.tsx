...
export function ScorecardEditor({ item, id }: { item: FabricItemType; id: string }) {
  ...
  ], [scorecardId, workspaceId, selectedGoalId, openScorecardInPbi, refreshScorecard, openCheckIn, openBinder, openHistory]);
    ...
    <ItemEditorChrome item={item} id={id} ribbon={scRibbon}
      ...
      main={
        <div className={s.pad}>
          ...
          <MessageBar intent="info">
            <MessageBarBody>
              <MessageBarTitle>Scorecard goals + connected metrics</MessageBarTitle>
              ...
              (value + status + note) with full history. <strong>Open in Power BI</strong> opens the Fabric scorecard
              canvas when one is bound.
            </MessageBarBody>
          </MessageBar>
          {scorecardId && (
            <>
                      ...
                      {goals.map((g, i) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <TableCell><Badge appearance="filled" color={scStatusColor(g.status)}>{scStatusLabel(g.status)}</Badge></TableCell>
