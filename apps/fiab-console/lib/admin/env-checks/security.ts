...
export const SECURITY_ENV_CHECKS: EnvSpec[] = [
  ...
  // an unset optional gate — which is correct: nothing is broken there.
  {
    ...
    required: ['LOOM_SHARING_URL'], warnOnMiss: true, optionalDefault: true,
