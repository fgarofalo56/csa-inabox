...
export const ENRICHMENT_ENV_CHECKS: EnvSpec[] = [
  // ── enrichment ──
  {
    id: 'graph-users', category: 'enrichment', title: 'Microsoft Graph user enrichment', severity: 'recommended',
  ...
  {
    id: 'graph-group-sync', category: 'enrichment', title: 'Entra group sync (access-package group targets)', severity: 'recommended',
  ...
  {
    id: 'svc-sharepoint-shortcuts', category: 'enrichment', title: 'OneDrive / SharePoint shortcuts', severity: 'recommended',
