...
const useStyles = makeStyles({
  ...
  body: { padding: tokens.spacingHorizontalL, overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: tokens.spacingHorizontalM, flex: 1 },
  empty: {
    display: 'flex', alignItems: 'center', justifyContent: 'center',
    padding: '40px', color: tokens.colorNeutralForeground3,
  },
  jsonArea: {
    width: '100%', minHeight: '160px',
    fontFamily: 'Consolas, monospace', fontSize: tokens.fontSizeBase200, padding: tokens.spacingHorizontalS,
    border: `1px solid ${tokens.colorNeutralStroke2}`,
    borderRadius: tokens.borderRadiusMedium,
