...
const QUERY_PALETTE: QueryStepDef[] = [
  ...
  { key: 'SqlSource', label: 'SQL database', color: '#0078d4',
  ...
  { key: 'LakehouseSource', label: 'Lakehouse table', color: '#107c10',
    description: 'Read a Fabric Lakehouse table.',
    body: 'let\n    Source = Lakehouse.Contents([]),\n    Nav = Source{[workspaceId=""]}[Data]\nin\n    Nav' },
  { key: 'CsvSource', label: 'CSV / text file', color: '#3aaaaa',
  ...
  { key: 'FilterRows', label: 'Filter rows', color: '#bd7800',
