...
const useStyles = makeStyles({
  ...
  acctLine: { color: tokens.colorNeutralForeground3, fontSize: tokens.fontSizeBase200, display: 'flex', alignItems: 'center', gap: tokens.spacingHorizontalSNudge, flexWrap: 'wrap' },
