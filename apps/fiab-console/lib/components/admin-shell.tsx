...
const SECTIONS: Section[] = [
  ...
  { href: '/admin/add-landing-zone', label: 'Add landing zone', icon: Server24Regular, description: 'Attach a new Data Landing Zone to your deployed hub (dlz-attach). Inherits the hub boundary, region and coordinates — a second Console cannot be deployed from here.' },
