...
const useStyles = makeStyles({
  ...
  gridWrap: { flex: 1, overflow: 'auto', maxHeight: 360, minWidth: 0 },
  ...
  td: { borderBottom: `1px solid ${tokens.colorNeutralStroke3}`, borderRight: `1px solid ${tokens.colorNeutralStroke3}`, padding: '3px 8px', whiteSpace: 'nowrap', maxWidth: 280, overflow: 'hidden', textOverflow: 'ellipsis' },
  ...
  inspect: { width: 240, flexShrink: 0, borderLeft: `1px solid ${tokens.colorNeutralStroke2}`, padding: '10px', display: 'flex', flexDirection: 'column', gap: '6px', backgroundColor: tokens.colorNeutralBackground2, overflow: 'auto', maxHeight: 360 },
  ...
  chartsWrap: { display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(340px, 1fr))', gap: '12px', padding: '12px', maxHeight: 520, overflow: 'auto' },
