...
const NAV_HINT_BY_HREF: Record<string, string> = {
  ...
  '/onelake': 'Lakehouse catalog — explore + govern',
  '/catalog': 'Unified search across every catalog',
  '/data-products': 'Published data products + contracts',
  '/org-reports': 'Organization report library',
  '/semantic-model': 'Tabular models over the lakehouse',
  '/thread': 'Cross-item lineage graph',
  '/marketplace': 'API + data-product exchange',
  '/governance': 'Policies, DLP, sensitivity',
  '/monitor': 'Activities + schedules',
  '/scheduler': 'Schedule + run jobs',
  '/copilot/skills': 'Author + manage Copilot skills',
