...
const useStyles = makeStyles({
  ...
  toolbar: { display: 'flex', gap: tokens.spacingHorizontalS, marginBottom: tokens.spacingVerticalM, alignItems: 'center', flexWrap: 'wrap' },
  filterInput: { minWidth: '200px' },
  ...
  labelChecklist: {
    ...
    border: `1px solid ${tokens.colorNeutralStroke2}`, borderRadius: tokens.borderRadiusSmall, padding: tokens.spacingVerticalS,
  },
  swatch: {
    display: 'inline-block', width: '12px', height: '12px', borderRadius: tokens.borderRadiusSmall,
    marginRight: tokens.spacingHorizontalXS, verticalAlign: 'middle', backgroundColor: tokens.colorNeutralForeground3,
  },
  swatchLg: {
    display: 'inline-block', width: '14px', height: '14px', borderRadius: tokens.borderRadiusSmall,
    marginRight: tokens.spacingHorizontalXS, verticalAlign: 'middle', backgroundColor: tokens.colorNeutralForeground3,
  },
  scopeBlock: {
    display: 'flex', flexDirection: 'column', gap: tokens.spacingVerticalS,
    border: `1px solid ${tokens.colorNeutralStroke2}`, borderRadius: tokens.borderRadiusMedium,
    padding: tokens.spacingVerticalS, backgroundColor: tokens.colorNeutralBackground2,
  },
  scopeGrid: { display: 'flex', flexDirection: 'column', gap: tokens.spacingVerticalS },
  scopeTags: { display: 'flex', flexWrap: 'wrap', gap: tokens.spacingHorizontalXS },
  // shared layout helpers (replace scattered inline styles for theme consistency)
  spread: { marginRight: 'auto' },
  mbSpace: { marginBottom: tokens.spacingVerticalS },
  gateWrap: { marginBottom: tokens.spacingVerticalS },
  muted: { color: tokens.colorNeutralForeground3 },
  labelDesc: { color: tokens.colorNeutralForeground3, marginTop: tokens.spacingVerticalXXS },
  cellMuted: { color: tokens.colorNeutralForeground3 },
  badgeSpace: { marginRight: tokens.spacingHorizontalXS },
  emptyHint: { color: tokens.colorNeutralForeground3 },
  notPublished: { color: tokens.colorPaletteRedForeground1 },
  consentHint: { marginTop: tokens.spacingVerticalXS },
  // Apply-label tab
  applyTitle: { marginBottom: tokens.spacingVerticalXS },
  applyIntro: { color: tokens.colorNeutralForeground3, marginBottom: tokens.spacingVerticalM },
  currentLabel: { marginLeft: tokens.spacingHorizontalS, color: tokens.colorNeutralForeground3 },
  evalDivider: {
    marginTop: tokens.spacingVerticalL, borderTop: `1px solid ${tokens.colorNeutralStroke2}`, paddingTop: tokens.spacingVerticalL,
  },
  evalHelp: { color: tokens.colorNeutralForeground3, marginBottom: tokens.spacingVerticalS },
  evalErr: { marginTop: tokens.spacingVerticalS },
  recCard: {
    marginTop: tokens.spacingVerticalS, padding: tokens.spacingVerticalM, borderRadius: tokens.borderRadiusMedium,
    border: `1px solid ${tokens.colorNeutralStroke2}`,
    backgroundColor: tokens.colorNeutralBackground2,
  },
  recLabel: { color: tokens.colorNeutralForeground3, marginBottom: tokens.spacingVerticalXS },
  recRow: { display: 'flex', alignItems: 'center', flexWrap: 'wrap', gap: tokens.spacingHorizontalS },
  recMarkings: { marginTop: tokens.spacingVerticalS },
  recMarkingsLabel: { color: tokens.colorNeutralForeground3, marginBottom: tokens.spacingVerticalXS },
  recMarkingTags: { display: 'flex', flexWrap: 'wrap', gap: tokens.spacingHorizontalXS },
  rawDetails: { marginTop: tokens.spacingVerticalS },
  rawSummary: { cursor: 'pointer', fontSize: '11px', color: tokens.colorNeutralForeground3 },
  rawPre: {
    marginTop: tokens.spacingVerticalXS, fontSize: '11px', backgroundColor: tokens.colorNeutralBackground1,
