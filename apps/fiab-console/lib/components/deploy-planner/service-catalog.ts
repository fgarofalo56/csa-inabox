...
export const SERVICE_CATALOG: ServiceDef[] = [
  ...
  { key: 'translator', label: 'Translator', category: 'ai', iconSlug: 'translator-text', bicepFlag: 'translatorEnabled',
    glyph: Translate24Regular, color: '#7c3aed',
    description: 'Neural machine translation (single-kind TextTranslation Cognitive Services account, Entra-only). Backs the TranslateText AI-enrichment pipeline activity.' },
