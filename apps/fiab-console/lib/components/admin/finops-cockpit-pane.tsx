...
/**
 * FinopsCockpitPane — C4 FinOps cockpit (loom-next-level ws-copilot-cost.md).
 *
 * Real-data surface composing the existing cost stack into one pane:
 ...
 *
 * IA-03 (loom-apex Phase B): this is the "Cockpit" TAB of /admin/finops — the
 * hub that also carries the Capacity & LCU and Chargeback-report tabs. The
 * c4-finops-hub kill-switch is owned by FinopsHubTabs, which hides this tab (and
 * defaults to Capacity & LCU) when the flag is OFF.
 */
