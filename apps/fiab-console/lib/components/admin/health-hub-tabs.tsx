...
import { ArrowTrendingLines24Regular, Flash24Regular, HeartPulse24Regular, ShieldCheckmark24Regular } from '@fluentui/react-icons';
...
type HubTab = 'audit' | 'journeys' | 'spark' | 'slo';
...
export function HealthHubTabs({
  ...
  // Deep link: /admin/health?tab=journeys|spark|slo (client-only read — no Suspense dance).
  useEffect(() => {
    try {
  ...
  }, [journeysEnabled, sparkEnabled, sloEnabled]);
