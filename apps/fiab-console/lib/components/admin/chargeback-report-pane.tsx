...
/**
 * ChargebackReportPane — the per-domain chargeback report (FGC-28).
 *
 ...
 * /admin/chargeback. It is now the "Chargeback report" TAB of the FinOps hub
 * (/admin/finops?tab=chargeback); the old route survives as a redirect stub.
 * The component is UNCHANGED — moved, not rewritten.
 */
...
export function ChargebackReportPane() {
