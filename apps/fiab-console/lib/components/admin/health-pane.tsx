...
const CATEGORY_ORDER: AuditCategory[] = ['identity', 'data-plane', 'permissions', 'azure-services', 'catalog-governance', 'ai-copilot', 'builders', 'workloads', 'security', 'enrichment', 'observability'];
