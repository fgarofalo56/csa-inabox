...
export const BUNDLE_ITEM_TYPES: Record<string, string[]> = {
  ...
  'app-fedramp-tracker': ['scorecard', 'kql-database', 'kql-dashboard',],
  'app-finops-cost': ['lakehouse', 'semantic-model', 'report', 'kql-database', 'kql-dashboard',],
  ...
  'app-real-time-dashboards': ['lakehouse', 'eventstream', 'kql-database', 'kql-dashboard', 'activator', 'semantic-model', 'report',],
