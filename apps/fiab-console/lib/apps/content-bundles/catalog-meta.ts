...
export const CATALOG_META: Record<string, CatalogMeta> = {
  ...
  'app-workspace-monitoring': { id: 'app-workspace-monitoring', name: 'Workspace Monitoring', description: 'Azure-native parity for Fabric workspace monitoring: a read-only ADX database of platform usage/performance telemetry fed by Azure Monitor diagnostic settings, with a pre-built Real-Time Dashboard. No Fabric required.', icon: 'Gauge20Regular', category: 'Operations', publisher: 'CSA' },
};
