...
const useStyles = makeStyles({
  ...
  kpi: { padding: tokens.spacingVerticalL, display: 'flex', flexDirection: 'column', gap: tokens.spacingVerticalXS, minWidth: 0 },
  kpiNum: { fontSize: tokens.fontSizeHero700, fontWeight: tokens.fontWeightSemibold, lineHeight: '1', overflowWrap: 'anywhere', wordBreak: 'break-word' },
  endpoint: { display: 'inline-flex', alignItems: 'center', gap: tokens.spacingHorizontalXXS, flexWrap: 'wrap', minWidth: 0, maxWidth: '100%', overflowWrap: 'anywhere', wordBreak: 'break-word' },
