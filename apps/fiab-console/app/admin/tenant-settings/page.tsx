...
const useStyles = makeStyles({
  ...
  toggleName: { fontSize: tokens.fontSizeBase300, fontWeight: 500 },
  toggleHelp: { fontSize: tokens.fontSizeBase200, color: tokens.colorNeutralForeground3, lineHeight: 1.45 },
  groupDesc: { color: tokens.colorNeutralForeground3, fontSize: tokens.fontSizeBase300, marginBottom: tokens.spacingVerticalS, display: 'block' },
  ...
  toggleId: { color: tokens.colorNeutralForeground3, fontFamily: 'Consolas, monospace', fontSize: tokens.fontSizeBase100 },
