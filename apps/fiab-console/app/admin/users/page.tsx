...
const useStyles = makeStyles({
  ...
  avatar: {
    flexShrink: 0, width: '32px', height: '32px', borderRadius: tokens.borderRadiusCircular,
  ...
  expandBtn: {
    ...
    background: 'none', border: 'none', padding: `${tokens.spacingVerticalXXS} ${tokens.spacingHorizontalXS}`,
  },
  popoverSurface: { maxWidth: '420px', maxHeight: '360px', overflowY: 'auto' },
  wsRoleTable: { width: '100%', borderCollapse: 'collapse', fontSize: tokens.fontSizeBase300 },
  wsRoleHeadCell: {
