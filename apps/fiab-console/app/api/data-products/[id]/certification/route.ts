...
import {
  evaluateCertification, deriveCertificationState, resolveEndorsement, gatherCertInputs,
...
/** Re-exported from the pure engine, where it now lives beside the evaluator it
 *  feeds — four call sites gather these inputs and a drifting copy would certify
