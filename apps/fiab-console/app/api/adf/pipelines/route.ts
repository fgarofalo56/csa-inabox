/**
 * Pipelines on the deployment-default Data Factory (the Factory Resources
 * navigator). Distinct from /api/items/adf-pipeline/[id]/* which targets the
 * Loom item's BOUND pipeline — this route lists/creates/deletes pipelines on
 * the factory directly so the ADF-Studio "Pipelines" group can render counts,
 * ＋ New, and delete.
 *
