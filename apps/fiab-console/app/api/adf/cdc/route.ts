/**
 * Change Data Capture (preview) on the SELECTED (or deployment-default) Data
 * Factory. Backs the "Change Data Capture (preview)" group in the Factory
 * Resources navigator and the AdfCdcEditor detail panel.
 *
