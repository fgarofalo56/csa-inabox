/**
 * Linked services on the SELECTED (or deployment-default) Data Factory (the
 * Manage hub).
 *
 ...
 * / factoryResourceGroup / factoryName); absent → the env-pinned default
 * (LOOM_SUBSCRIPTION_ID / LOOM_DLZ_RG / LOOM_ADF_NAME). Honest 503 gate with the
 * exact missing var when neither is configured. Real ARM REST. No mocks.
 *
