...
const METHODS: AuthMethod[] = ['entra-mi', 'sql-password', 'connection-string', 'account-key', 'service-principal', 'service-key', 'basic'];
...
export async function POST(req: NextRequest) {
  ...
  try {
    const conn = await createConnection(session, {
      ...
      projectId: body?.projectId, dataGateway: body?.dataGateway,
