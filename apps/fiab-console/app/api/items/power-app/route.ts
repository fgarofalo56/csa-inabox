/**
 * GET /api/items/power-app?envId=<env> — list Power Apps in environment.
 */
import { NextRequest, NextResponse } from 'next/server';
import { getSession } from '@/lib/auth/session';
import { listPowerApps, PowerPlatformError } from '@/lib/azure/powerplatform-client';
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    return NextResponse.json({ ok: true, envId, apps });
