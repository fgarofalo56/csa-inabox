/**
 * GET  /api/items/geo-dataset — list owned items of type geo-dataset
 * POST /api/items/geo-dataset — persist a new geo-dataset item; state is freeform per type
 */
