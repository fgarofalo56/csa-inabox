/**
 * GET  /api/items/dbt-job       — list dbt-job items owned by tenant.
 * POST /api/items/dbt-job       body { workspaceId, displayName,
 ...
 *     target: string,            // default "prod"
 *     profilesYaml: string,
 *     models: string[],          // optional --select list
 *     commands?: string[],       // defaults to ["dbt deps", "dbt run"]
 *     clusterId?: string,        // existing Databricks cluster id
 *     databricksJobId?: number,  // persisted on first run
 *   }
 */
