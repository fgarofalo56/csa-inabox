/**
 * GET  /api/items/gql-graph — list owned items of type gql-graph
 * POST /api/items/gql-graph — persist a new gql-graph item; state is freeform per type
 */
