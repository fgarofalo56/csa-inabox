/**
 * GET    /api/items/postgres-flexible-server/[id]/firewall?server=<name>
 * POST   /api/items/postgres-flexible-server/[id]/firewall   body { server, name, startIpAddress, endIpAddress }
 * DELETE /api/items/postgres-flexible-server/[id]/firewall?server=<name>&rule=<name>
 *
