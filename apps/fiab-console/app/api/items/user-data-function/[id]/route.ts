/**
 * Generic CRUD for the 'user-data-function' item — the persistence handler the Phase-4
 * editor's useItemState(<type>, id) drives:
 *   GET   /api/items/user-data-function/<id>          → { id, displayName, state, updatedAt }
 *   PATCH /api/items/user-data-function/<id> { state } → persists, returns { updatedAt }
 *   DELETE /api/items/user-data-function/<id>          → removes the item
 *
...
const ITEM_TYPE = 'user-data-function';
