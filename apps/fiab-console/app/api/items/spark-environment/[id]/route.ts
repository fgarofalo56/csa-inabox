/**
 * GET    /api/items/spark-environment/[id]   → return persisted env spec.
 * PUT    /api/items/spark-environment/[id]   body { displayName?, description?, state? }
 * DELETE /api/items/spark-environment/[id]   → cosmos delete.
 */
