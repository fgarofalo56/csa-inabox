/**
 * GET  /api/items/geo-map — list owned geo-map items
 * POST /api/items/geo-map — persist a geo-map item (Azure Maps account + style + tile layer)
 */
