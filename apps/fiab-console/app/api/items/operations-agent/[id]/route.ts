/**
 * Generic CRUD for the 'operations-agent' item — the persistence handler the editor's
 * useItemState('operations-agent', id) drives (GET → { state, updatedAt }; PATCH { state }).
