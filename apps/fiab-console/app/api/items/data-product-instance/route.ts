/**
 * GET  /api/items/data-product-instance — list owned items of type data-product-instance
 * POST /api/items/data-product-instance — persist a new data-product-instance item; state is freeform per type
 */
...
const ITEM_TYPE = 'data-product-instance';
