/**
 * GET  /api/items/cypher-graph — list owned items of type cypher-graph
 * POST /api/items/cypher-graph — persist a new cypher-graph item; state is freeform per type
 */
