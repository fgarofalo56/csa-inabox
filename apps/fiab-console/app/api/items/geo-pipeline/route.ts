/**
 * GET  /api/items/geo-pipeline — list owned items of type geo-pipeline
 * POST /api/items/geo-pipeline — persist a new geo-pipeline item; state is freeform per type
 */
