...
const METHOD_LABEL: Record<string, string> = {
  'entra-mi': 'Managed identity', 'sql-password': 'Username + password', 'connection-string': 'Connection string',
  'account-key': 'Account key', 'service-principal': 'Service principal', 'service-account-key': 'Service account key',
};
